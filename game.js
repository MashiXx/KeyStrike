...
class Game {
  ...
  _generateSentences(count) {
    const pools = {
      ...
      vi: [
        "con cao nau nhanh nhen nhay qua con cho luoi",
        "hoc hanh cham chi se giup ban thanh cong",
        "cuoc song la nhung chuoi ngay dang nho",
        "hay tin vao chinh minh va dung bao gio bo cuoc",
        "moi ngay la mot co hoi moi de bat dau",
        "thanh cong den tu su kien tri va no luc",
        "hay lam viec cham chi va luon co gang het minh",
        "ban se dat duoc muc tieu neu khong tu bo",
        "tri thuc la suc manh cua moi con nguoi",
        "doc sach giup mo rong tam nhin va hieu biet",
        "lap trinh la nghe thuat giai quyet van de",
        "moi dong code deu co mot cau chuyen rieng",
        "hay viet code sach va de doc de hieu",
        "loi la co hoi de hoc va phat trien ban than",
        "hay luon hoc hoi va cai tien moi ngay",
        "cong nghe thay doi the gioi tung ngay mot",
        "sang tao la chia khoa cua thanh cong lon",
        "nhung gi kho khan nhat se giup ban truong thanh",
        "dung so that bai hay so khong dam thu",
        "lam viec nhom giup dat ket qua tot hon",
        "hay bat dau tu nhung dieu nho nhat co the",
        "moi buoc di deu dua ban den gan hon muc tieu",
        "su tap trung la bi quyet cua moi thanh cong",
        "hay luon giu tinh than lac quan va vui ve",
        "thoi gian la tai san quy gia nhat cua ban",
        "ban co the lam duoc bat cu dieu gi neu muon",
        "nhung nguoi chien thang khong bao gio bo cuoc",
        "cuoc chien bat dau hay chuan bi san sang",
        "phong thu vung chac hoac doi mat that bai",
        "tan cong manh me va pha huy thanh doi thu",
        "toc do va chinh xac la chia khoa chien thang",
        "moi phim bam deu co the thay doi ket qua",
        "binh linh xong vao tran chien khong do du",
        "giu binh tinh va tiep tuc go khong ngung",
        "doi thu nhanh hon nhung ban thong minh hon",
        "phong ten lua va nghien nat phao dai ke thu",
        "tuong thanh sup do duoi lan dan du doi",
        "hay chien dau het minh de gianh chien thang",
        "tung vien gach roi xuong khi thanh bi tan pha",
        "lua chay ngut troi tren chien truong ac liet",
      ],
    };
